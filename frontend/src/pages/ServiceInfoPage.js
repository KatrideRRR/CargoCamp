    ...
    return (
        <div className="info-page-container">
            <div className="info-page-card">
                    ...
                    <div className="tariff-list">
                        ...
                        <div className="tariff-item">
                            ...
                            <p className="tariff-desc">
                                ...
                                <code> Задолженность</code> в личном кабинете). Конкретная сумма оплаты
                ...
                {/* Условия оказания услуг (для банка) */}
                <section className="info-section">
                    <h2 className="info-section-title">5. Условия оказания услуг</h2>

                    <h3 className="info-subhead">Срок предоставления услуг</h3>
                    <ul className="info-list">
                        <li><b>Продвижение заказа (50 ₽ / 100 ₽ / 150 ₽):</b> активируется сразу после оплаты. Срок действия — 24 часа.</li>
                        <li><b>Комиссия исполнителя за взятие заказа “Наличные” (200 ₽):</b> учитывается сразу после оплаты и даёт доступ к функционалу «взять заказ».</li>
                        <li><b>Premium (2500 ₽ / 9000 ₽):</b> активируется сразу после оплаты на срок 7 дней / 30 дней соответственно.</li>
                        <li><b>Погашение задолженности:</b> сумма долга отображается перед оплатой и уменьшается сразу после успешного платежа.</li>
                    </ul>

                    <h3 className="info-subhead">Порядок оплаты</h3>
                    <p className="info-text">
                        Онлайн-оплата на сайте применяется только для оплаты цифровых услуг сервиса CargoCamp
                        (продвижение, сервисная комиссия, Premium, погашение задолженности).
                        <b> Оплата работ исполнителей онлайн не принимается.</b> Заказчик и исполнитель рассчитываются между собой наличными напрямую.
                    </p>

                    <h3 className="info-subhead">Доставка</h3>
                    <p className="info-text">
                        Доставка не применяется, так как CargoCamp оказывает цифровые (информационные) услуги.
                    </p>

                    <h3 className="info-subhead">Возвраты</h3>
                    <p className="info-text">
                        Возврат возможен, если услуга фактически не была предоставлена по вине сервиса
                        (например, оплата прошла, а функция не активировалась). Для обращения по возврату:
                        <b> partner@cargocamp.ru</b>. Срок рассмотрения — до 10 календарных дней.
                    </p>
                </section>

                {/* Контакты и реквизиты */}
                <section className="info-section">
                    <h2 className="info-section-title">6. Контакты и реквизиты</h2>
                    <p className="info-text">
